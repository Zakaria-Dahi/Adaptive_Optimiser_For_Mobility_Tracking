...
% Probability of Mutation : deterministic adaptive mutation probability using the linear decreasing strategy : 0.3 - (1/L)
...
%% Prameters  of the Genetic Algorithm  ----------------------
     ...
     rate_decrease = (0.3 - (1/Dimension))/(iter/indiv);
...
%% -- Decreasing The Mutation Probability ---------------------------------
pm = pm - rate_decrease;
