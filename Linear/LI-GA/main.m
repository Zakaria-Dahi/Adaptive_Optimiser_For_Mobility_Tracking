...
% Probability of Mutation : deterministic adaptive mutation probability using the linear increasing strategy : 0.3 - (1/L)
...
%% Prameters  of the Genetic Algorithm  ----------------------
     ...
     pm = 0.3;  % as recomended by Professor Alba  
     rate_increase = (0.3 - (1/Dimension))/(iter/indiv);
...
%% -- Increasing The Mutation Probability ---------------------------------
pm = pm + rate_increase;
